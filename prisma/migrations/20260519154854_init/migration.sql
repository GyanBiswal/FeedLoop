...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('UNDER_REVIEW', 'PLANNED', 'IN_PROGRESS', 'DONE');
...
-- CreateIndex
CREATE UNIQUE INDEX "Subscription_email_workspaceId_key" ON "Subscription"("email", "workspaceId");
